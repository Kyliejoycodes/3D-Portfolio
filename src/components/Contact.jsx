  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_r23eckr',
      {
        ...
        to_email: 'k22morga@uwaterloo.ca',
      ...
      <motion.div variants={slideIn('left', "tween", 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <label className="flex flex-col">
            ...
            <textarea rows="7" name="message" value={form.message} onChange={handleChange} placeholder="What Would You Like to Share?" className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium"/>
...
export default SectionWrapper(Contact, "contact") //second id allows access to page from navbar