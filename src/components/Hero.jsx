  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      <div className="flex flex-col justify-center items-center mt-5">
        ...
        <div>
        <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-[#915eff]">Kylie</span></h1>
        <p className={`${styles.heroSubText} mt-2 text-white-100`}>

          University of Waterloo Computer Engineering<br className="sm:block hidden"/>| Morgan Industry
        </p>
      </div>
      </div>
      <ComputersCanvas />
